...
The CCTP Valid frontend needs a **WalletConnect Project ID** so users can connect their crypto wallets (like MetaMask, Rainbow, etc.) to the app.
...
4. Give it a name like `CCTP Valid` and select **App** as the type
